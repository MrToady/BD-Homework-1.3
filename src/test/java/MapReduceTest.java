...
public class MapReduceTest {
    ...
    private MapReduceDriver<LongWritable, Text, HighBitOSWritable, IntWritable, Text, IntWritable> mapReduceDriver;
    ...
    public void testIfMapReduceProcessData() throws IOException {
        mapReduceDriver.withInput(new LongWritable(0), LOG_STRING_1);
        mapReduceDriver.withInput(new LongWritable(0), LOG_STRING_2);
        mapReduceDriver.withInput(new LongWritable(0), LOG_STRING_3);
        mapReduceDriver.withInput(new LongWritable(0), LOG_STRING_4);
        mapReduceDriver.withInput(new LongWritable(0), LOG_STRING_5);
