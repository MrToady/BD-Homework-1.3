...
public class HighBitPriceMapperTest {
    ...
    public void testIfMapperParsesLosStringProperly() throws IOException {
        mapDriver.withInput(new LongWritable(), LOG_STRING_1);
        mapDriver.withInput(new LongWritable(), LOG_STRING_2);
    ...
    public void testIfMapperParsesLosStringProperly2() throws IOException {
        mapDriver.withInput(new LongWritable(), LOG_STRING_3);
        mapDriver.withInput(new LongWritable(), LOG_STRING_4);
        mapDriver.withInput(new LongWritable(), LOG_STRING_5);
